---
name: vue-migration
description: Vue 2 to Vue 3 migration system. Activate when the user asks to migrate, upgrade, or convert a Vue 2 application to Vue 3.
---
...
| `vue-migration-patterns` | All | Project scanner + complete migration reference — run scanner before planning, load phase-specific references during execution, verify with breaking-changes.md during review |
