...
The following skills are installed globally in `~/.agents/skills/` and their content is available as reference knowledge. Draw on this domain expertise when writing migration code:
